//This code is from a previous project, I'm just using this as a bit of a reminder of how middleware structure looks like
// this code normally uses other code to actually function so it's not standalone
import './db.mjs';
